...
/// <summary>
/// This class extends the "BaseModule" class and provides module-specific implementation for offset-based modules.
/// </summary>
/// <see cref="BaseModule"/>
public class OffsetModule : BaseModule
{
    private new OffsetModuleData data;
    ...
    {
        data = (OffsetModuleData)baseModuleData;
...
[Serializable]
public class OffsetModuleData : BaseModuleData
{
    /// <summary>
    /// The offset
    /// </summary>
