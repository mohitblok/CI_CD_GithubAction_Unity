...
public abstract class CharacterBaseState : State
{
    ...
    protected void CalculateMoveDirection()
    {
        ...
        Vector2 walkInput = InteractionSystem.PCGamepad.MovementLevel1.Walk.ReadValue<Vector2>();

        Vector3 moveDirection = cameraForward.normalized * walkInput.y + cameraRight.normalized * walkInput.x;
